	...
	{#if spotlight}
		...
		>
			<div
				...
				style="left: {spotlightLeft}; top: {spotlightTop}; transform: translate(-50%, -50%); transition: left 0.2s ease-out, top 0.2s ease-out; background: radial-gradient(circle, oklch(0.546 0.245 262.881 / 0.332) 0%, transparent 40%);"
			></div>
		</div>
	{/if}
</div>
